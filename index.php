...
<div class="banner-slider-area-one slider-gird">
    <!-- Start Slider Area  -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="tmp-section-title-border text-center">
                        ...
                        <h2 class="title w-700 tmp-title-split">Premium Services.</h2>
                    </div>
                </div>
            </div>
            <div class="row g-5 service-wrapper mt--10">
                    ...
                    <div class="service service__style--1 bg-color-card radius text-start tmp-border-none tmponhover">
                        ...
                        <div class="content">
                            <h4 class="title w-600">
                                <a href="service-details.html">Software Engineering & Product Development</a>
                            </h4>
                            <p class="description mb--0">We design and deploy enterprise-grade software solutions, including cloud-native platforms, API-driven systems, automation tools, and data-driven applications.</p>
                            <div class="discover-btn mt--30">
                                <a class="tmp-btn round btn-small btn-border hover-icon-reverse" href="services/">
                                    <span class="icon-reverse-wrapper">
                        ...
                        <div class="shape-service-1">
                            <img src="<?= img("assets/images/services/shape/01.png") ?>" alt="service">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="service service__style--1 bg-color-card radius text-start tmp-border-none tmponhover">
                        ...
                        <div class="content">
                            <h4 class="title w-600">
                                <a href="service-details.html">Financial Technology Infrastructure</a>
                            </h4>
                            <p class="description mb--0">We build digital payment systems, wallet infrastructures, transaction processing platforms, virtual card systems, lending solutions, and digital asset integrations — engineered with compliance, security, and scalability at their core.</p>
                            <div class="discover-btn mt--30">
                                <a class="tmp-btn round btn-small btn-border hover-icon-reverse" href="services/">
                                    <span class="icon-reverse-wrapper">
                    <span class="btn-text">Discover services</span>
                ...
                <div class="col-xl-4 col-lg-6 col-md-6 col-sm-6 col-12">
                    <div class="service service__style--1 bg-color-card radius text-start tmp-border-none tmponhover">
                        ...
                        <div class="content">
                            <h4 class="title w-600">
                                <a href="service-details.html">Enterprise Business Systems</a>
                            </h4>
                            <p class="description mb--0">Our team develops operational and financial management tools that streamline workflows, enhance reporting visibility, and enable intelligent decision-making.</p>
                            <div class="discover-btn mt--30">
                                <a class="tmp-btn round btn-small btn-border hover-icon-reverse" href="services/">
                                    <span class="icon-reverse-wrapper">
                    <span class="btn-text">Discover services</span>
                ...
                <div class="col-lg-5">
                    <div class="thumbnail-about-8">
                        ...
                        <div class="small-iamge-area images-left-right-float">
                            <img src="<?= img("assets/images/about/about-12.jpg") ?>" alt="" class="rounded-8px" loading="lazy">
                            <!-- <div class="video-icon">
                                <a class="tmp-btn rounded-player popup-video" href="#">
                ...
                <div class="col-lg-7 pl--60 pl_md--10 pl_sm--10 mt_md--30 mt_sm--30">
                    <div class="about-wrapper-8">
                        ...
                        <ul class="tmp-list-item-half">
                            <li>
                                <div class="icon">
                                    <svg version="1.1" id="fi_263115" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" style="enable-background:new 0 0 512 512;" xml:space="preserve">
                                        <g>
                                            <g>
...
C455.549,238.499,449.593,232.543,442.246,232.543z"></path>
                            ...
                            <li>
                                <div class="icon">
                                    <svg version="1.1" id="fi_36447" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="31.559px" height="31.559px" viewBox="0 0 31.559 31.559" style="enable-background:new 0 0 31.559 31.559;" xml:space="preserve">
                                        <g>
                                            <g>
        ...
        <div class="row">
            <div class="col-lg-12">
                <!-- <div class="tmp-portfolio-filter filter-button-default messonry-button text-center mb--30">
                    ...
                    <button data-filter=".cat--1"><span class="filter-text">Grow Business</span></button>
                    <button data-filter=".cat--2"><span class="filter-text">Art Design</span></button>
                    <button data-filter=".cat--4"><span class="filter-text">App Development</span></button>
                </div> -->
                <div class="portfolio-items grid-metro4 mesonry-list">
                    <div class="resizer"></div>
                    <!-- Start Single Portfolio  -->
                    <div class="portfolio-4 cat--1 cat--4">
                        <div class="tmp-card portfolio">
                            <div class="inner">
                                <div class="thumbnail">
                                    <figure class="card-image">
                                        <a href="portfolio-details.html">
                                            <img src="assets/images/portfolio/xorachat.jpg" style="height: 225px" alt="Portfolio-01">
                                        </a>
                                    </figure>
                    ...
                    <!-- Start Single Portfolio  -->
                    <div class="portfolio-4 cat--4">
                        <div class="tmp-card portfolio">
                            <div class="inner">
                                <div class="thumbnail">
                                    <figure class="card-image">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/portfolio/zeeqcore.jpg" style="height: 225px" alt="Portfolio-01">
                                        </a>
                                    </figure>
                    ...
                    <!-- Start Single Portfolio  -->
                    <div class="portfolio-4 cat--4 cat--1">
                        <div class="tmp-card portfolio">
                            <div class="inner">
                                <div class="thumbnail">
                                    <figure class="card-image">
                        ...
                        <div class="tmp-card portfolio">
                            <div class="inner">
                                <div class="thumbnail">
                                    <figure class="card-image">
                                        <a href="javascript:void(0)">
                                            <img src="assets/images/portfolio/zeeqpay.jpg" style="height: 225px" alt="Portfolio-01">
                                        </a>
                                    </figure>
                                    <a class="tmp-overlay" href="javascript:void(0)"></a>
                                </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="tmp-section-title-border text-center">
                    ...
                    <h2 class="title w-700 tmp-title-split">Our Recent Articles</h2>
                </div>
            </div>
        </div>
