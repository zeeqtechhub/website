...
<?php require_once (path("header.php")) ?>
        ...
        <!-- Srart About Area  -->
        <div class="about-area about-style-4 tmp-section-gapTop pb--50">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <div class="thumbnail-about-8">
                            ...
                            <div class="small-iamge-area images-left-right-float">
                                <img class="rounded-8px" src="<?= img("assets/images/about/about-12.jpg") ?>" alt="" loading="lazy">
                    ...
                    <div class="col-lg-7 pl--60 pl_md--10 pl_sm--10 mt_md--30 mt_sm--30">
                        <div class="about-wrapper-8">
                            ...
                            <div class="discription">
                                ...
                                We operate at the intersection of innovation, engineering excellence, and financial technology, delivering scalable digital solutions that power businesses across emerging and global markets.
                                ZeeqTech is not just a technology provider we are architects of systems that redefine how businesses operate, transact, and scale.
                            </div>
                            <ul class="feature-list-service row mt--0 g-5">
                                <li class="col-lg-6">
                                    ...
                                    <div class="title-wrapper">
                                        <h4 class="title">Strategic thinking </h4>
                                        <!-- <p class="text"></p> -->
                                    </div>
                                </li>
                                <li class="col-lg-6">
                                ...
                                <li class="col-lg-6">
                                    ...
                                    <div class="title-wrapper">
                                        <h4 class="title">Secure system architecture </h4>
                                        <!-- <p class="text"></p> -->
                                    </div>
                                </li>
                                <li class="col-lg-6">
                                    ...
                                    <div class="title-wrapper">
                                        <h4 class="title">Emerging technologies </h4>
                                        <!-- <p class="text"></p> -->
                                    </div>
                                </li>
                            </ul>
                    ...
                    <div class="row mt--50">
                        <div class="col-lg-6">
                            <h5 class="mb-2">What We Offer</h5>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="discription mb--10">To become a trusted technology infrastructure company powering digital finance and business enterprise transformation.</div>
                        
                            <h5 class="mb-2 mt-5">Our Mission</h5>
                            <div class="discription mb--10">To design and deploy innovative, secure, and scalable software systems that empower businesses, financial institutions, and digital economies worldwide.</div>
                        </div>
                    </div>
                </div>
            </div>
